...
class MailingList(models.Model):
    ...
    #send_to_active = models.BooleanField(default=False,
#                                          verbose_name=u"Envoyer aux actifs",
#                                          help_text=u"Envoyer uniquement aux chasseurs qui ont postés au moins une fois"
    def __unicode__(self):
        return self.subject
